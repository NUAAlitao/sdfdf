...
public class StudentManager {
	...
	public int updateStudent(String sno, UpdateFrame updateFrame){
		...
		String sqlUpdate="update "+table+" set sno=?,sname=?,ssex=?,dept=?,grade=?,sage=?,phone=?,address=? "+
				"where sno=?";
		int num=0;
	...
	public void queryStudent(String sno, UpdateFrame updateFrame){
		...
		PreparedStatement pStatement=null;
		ResultSet rs=null;
		String sqlQuery="select * from "+table+" where sno=?";
	...
	public int deleteStudent(String sno){
		Connection conn=null;
		PreparedStatement pStatement=null;
		String sql="delete from "+table+" where sno=?";
		int num=0;
		conn=ConnectionManager.getConnection();
		try {
	...
	public int addStudent(Student student){
		Connection conn=null;
		PreparedStatement pStatement=null;
		String sql="insert into "+table+"(sno,sname,ssex,dept,grade,sage,phone,address)" +
					" values(?,?,?,?,?,?,?,?)";
		int num=0;
		conn=ConnectionManager.getConnection();
		try {
